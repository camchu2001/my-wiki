...
* Inside the callback function, you define the operation or action to be performed on each element of the array.
...
* Inside the callback function, you **define the transformation or operation** to be applied to each element of the array. 
...
* This callback function is invoked for each element and **returns a boolean value** (`true` or `false`).
