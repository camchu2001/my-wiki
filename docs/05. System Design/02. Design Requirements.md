...
* If we want to reduce the downtime by a factor of **10**, this would take our uptime to 99.9% and downtime to 0.1%. → it’s quite difficult to make this type of improvement.
...
* SLA refers to an agreement a company makes with their clients or users to provide a certain metric of uptime, responsiveness, and responsibilities.
* SLO refers to an objective your team must hit to meet the SLA requirements. For example, AWS's monthly SLA is 99.99%99.99% and if not met, they refund a percentage of service credit.