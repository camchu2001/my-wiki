...
|                                                                                                                                                                        |                                                                                                                                                                    |
| 3. The `average()` function calls `add()` function → the JavaScript engine creates another function execution context for `add()`, places it on top of the call stack. |                                                                                                                                                                    |
| ![](https://i.imgur.com/eeSPudm.png)                                                                                                                                   |                                                                                                                                                                    |
