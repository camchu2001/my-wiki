...
## 2. Operators
There are many types of operators in JavaScript, the two covered in this section are a**ssignment and comparison operators**. Another type of operator that will be covered in [[03. Conditionals]] is the **logical operator**. 
