...
> **Resources**
> [HTML vs. CSS vs. Javascript: What’s the Difference?](https://www.brytdesigns.com/html-css-javascript-whats-the-difference) <br>
### General Definition
...
>[Introduction to HTML](https://www.youtube.com/watch?v=LGQuIIv2RVA&list=PL4-IK0AVhVjM0xE0K2uZRvsM7LkIhsPT-)<br>
...
# 3. HTML Boilerplate
> **Resources**
> [HTML Boilerplate](https://www.theodinproject.com/lessons/foundations-html-boilerplate)<br>
