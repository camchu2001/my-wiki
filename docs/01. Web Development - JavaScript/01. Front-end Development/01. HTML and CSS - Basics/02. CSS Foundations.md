...
**Descendant combinators** allow you to select elements based on their relationship to other elements. It is represented by a ***single space between two CSS selectors***. 
