...
### 1. Flexbox vs. Grid
> **Resource**
> - [CSS Grid vs. Flexbox](https://webdesign.tutsplus.com/flexbox-vs-css-grid-which-should-you-use--cms-30184a)
> - [CSS Grid Use Cases](https://www.youtube.com/watch?v=HYji_V2aYa0)

A way to decide between Grid and Flexbox is to consider if your design starts from **the content or the layout.**
#### 1. Content First Design
- You start with clarity on how the content should be structured and presented.
- The layout follows and adapts to the content.
- Flexbox is well-suited for this approach because it provides control over the behavior of items (how they grow, shrink, their ideal size, and position in relation to each other) through logical rules.
...
- You decide how you want the layout to be arranged first, and then you fill in the content.
