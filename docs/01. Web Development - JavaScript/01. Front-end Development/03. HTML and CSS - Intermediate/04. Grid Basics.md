...
> 
> As seen in the demonstration image below, `auto-fit` doesn’t create any more tracks after Item 3, but `auto-fill` creates 1 more track to fill the entire grid, even though there are no more items to fill the remaining tracks.
> 
![](https://i.imgur.com/p9uMgCM.png)
> 
