...
```
### 2. Radio buttons
Radio buttons allow us to create multiple options so that the user can choose one. To create radio buttons, we use the ever-adaptable input element again with a `type` attribute of “radio”. 
```html
<h1>Ticket Type</h1>
<div>
