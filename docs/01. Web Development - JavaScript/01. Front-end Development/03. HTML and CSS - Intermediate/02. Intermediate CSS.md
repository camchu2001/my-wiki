...
<u>**Example**</u>: A parent `<div>` with a `font-size` set to `16px`. If you set the `width` of a child element within that `<div>` to `2em`, the child element's width will be `32px` (= `16px` x 2).
