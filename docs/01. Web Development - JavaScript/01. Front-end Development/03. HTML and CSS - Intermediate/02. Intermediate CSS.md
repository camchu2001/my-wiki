...
### 3. Pseudo-selectors
#### 1. pseudo-class
A **pseudo-class** is a selector that **selects elements that are in a specific state**. Pseudo-classes are represented by a single colon (`:`) followed by the pseudo-class name. 
...
#### 2. pseudo-element
Pseudo-elements are represented by two colons (`::`) followed by the pseudo-element name. They are used to target elements that _don’t_ normally exist in the markup and aren’t elements at all. 
