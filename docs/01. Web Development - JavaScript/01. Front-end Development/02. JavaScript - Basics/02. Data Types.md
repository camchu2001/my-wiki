...
> <u>**Note**</u>: There are no character `char` type in JavaScript. 

 1. A **string** is a **piece of text** and is declared with surrounding *quotes*. There are three types of quotes we can use to surround a string in JavaScript: 
* Double quote: `"Hello"`
* Single quote: `'Hello'`
* Backticks: ``Hello` `
